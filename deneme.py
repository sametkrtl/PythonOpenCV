...
class EnhancedAnonymizationApp:
    ...
    def create_enhanced_interface(self):
        ...
        with gr.Blocks(css=css, title="PDF Kişisel Bilgi Anonimleştirici - Minimal", theme=theme) as interface:
            gr.Markdown("""
            # 🔐 PDF Kişisel Bilgi Anonimleştirici — Minimal
            **PDF yükle**, **güven eşiği** seç ve **Custom Lists** ile işlemi başlat.
            """)
            ...
            def _run_minimal(pdf, thr, progress=gr.Progress()):
            ...
            process_btn.click(
                _run_minimal,
                inputs=[pdf_input, confidence_threshold],
                outputs=[output_pdf, status_text],
